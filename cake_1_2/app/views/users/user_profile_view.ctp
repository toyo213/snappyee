...
<?php 	
	...
	echo "<a href=/employers/create_message?rid=".$prof['User']['id'].">メッセージを送信　Send Message</a>";
	echo  "<br/><br/><a href=http://job-tiger.com/employers/btocWink?rid=".$prof['User']['id']."><img src=http://job-tiger.com/images/btn_like.png></a>";
}	
?>
