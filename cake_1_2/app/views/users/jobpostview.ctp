...
<h2><?php echo $jobpost["Jobpost"]["corporation"] ?></h2>
		...
		<br/>
		<br/>
		<a href="http://job-tiger.com/users/ctobWink?rid=<?php echo $jobpost['Jobpost']['employer_id'];?>&jid=<?php echo $jobpost["Jobpost"]["id"];?>"><img src="http://job-tiger.com/images/btn_like.png"></a></p>
		<br/>
		</li>
		</ul>	
