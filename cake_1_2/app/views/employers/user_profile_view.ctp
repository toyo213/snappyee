...
<a href=/employers/create_message?rid=<?php echo $user_profile["User_profile"]["id"];?> >Send Message </a>
<br/>
<br/>

<a href=./btocWink?rid=<?php echo $user_profile["User_profile"]["id"] ;?>><img src="/images/btn_like.png"> </img></a>
