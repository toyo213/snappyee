...
<head>
	...
	<title>
		<?php __('Snappyee: Color your life'); ?>
		<?php echo $title_for_layout; ?>
	</title>
	   <link rel="stylesheet" type="text/css" href="app/webroot/css/main.css">
...
<div id="footer"> 
			...
			<p><a href="/">Home</a> &middot; <a href="http://213stomperz.com/">Corporate</a> </p> 
			</div> 
		</div>	
</body> 
