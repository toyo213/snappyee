...
//}
    ...
    <div class="photo radiux3px">
            <a href="#"><img src="<?php echo $list[$numbers[$i]]['Photo']['fbpath'];?>" width="260px" alt="" /></a>
            <!--
...
<div class="photoList rightMargin5px leftcol">
    ...
    <?php while ($i < 13): ?>
        <div class="photo radiux3px">
            <a href="/users/fbpict_like/"><img src="<?php echo $list[$numbers[$i]]['Photo']['fbpath']; ?>" width="190px" alt="" /></a>
            <!--
...
<div class="photoList leftcol">
    ...
    <?php while ($i < 18): ?>
    <div class="photo radiux3px">
            <a href="#"><img src="<?php echo $list[$numbers[$i]]['Photo']['fbpath']; ?>" width="190px" alt="" /></a>
            <!--
         <div class="photoUnder">
             <div id="fb-root"></div><script src="#"></script><fb:like href="#" send="false" layout="button_count"width="180" show_faces="false" font=""></fb:like>
         </div>
